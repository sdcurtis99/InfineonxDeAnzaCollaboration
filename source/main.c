...
int main(void)
{
	// Set up pin for voltage flux
/*
	#define PIN_9_1 P9_1;
	cyhal_gpio_t my_gpio = PIN_9_1;

	cybsp_init();
	__enable_irq();
	cyhal_gpio_init(my_gpio, CYHAL_GPIO_DIR_OUTPUT, false);

*/
//	 cy_rslt_t result2;
//	/* Initialize the user LED  */
//	result2 = cyhal_gpio_init(P9_1, CYHAL_GPIO_DIR_OUTPUT, CYHAL_GPIO_DRIVE_STRONG, CYBSP_LED_STATE_OFF);
//	/* LED OFF */
//	cyhal_gpio_write(P9_1, CYBSP_LED_STATE_OFF);
    ...
    cyhal_gpio_t pin9_1 = P9_1;

    result = cyhal_gpio_init(pin9_1, CYHAL_GPIO_DIR_OUTPUT, CYHAL_GPIO_DRIVE_STRONG, false);

    if(result != CY_RSLT_SUCCESS){
    	CY_ASSERT(0);
    }

    //cyhal_gpio_write(P9_1, true);
